...
from model.buildingblocks import DoubleConv, ExtResNetBlock, create_encoders, create_decoders
...
class Abstract3DUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        if isinstance(f_maps, int):
            f_maps = self.number_of_features_per_level(f_maps, num_levels=num_levels)
